...
DEFAULT_SCHEDULES = {
    "pagi": [
        ("07:00", "🌅 Req PGA"),
        ("07:45", "⏰ Reminder — 1 jam lagi @pakustadddke2"),
        ("08:00", "📊 Jadwal Bukti JP & Paito JP"),
        ("08:45", "⏰ Reminder — 1 jam lagi @pakustadddke2"),
    ...
    "siang": [
        ...
        ("15:45", "⏰ Reminder — 1 jam lagi @pakustadddke2"),
        ("16:00", "📝 Isi WLBC"),
        ("16:10", "🎰 Macau"),
        ("16:45", "⏰ Reminder — 1 jam lagi @pakustadddke2"),
        ("17:00", "🎟️ IDN Raffle"),
        ("17:45", "⏰ Reminder — 1 jam lagi @pakustadddke2 / Update TO"),
        ("17:55", "🎲 Singapore"),
        ("18:05", "🌅 PGA, Update TO Kemarin & Slot Mingguan & Total Online"),
        ("18:45", "⏰ Reminder — 1 jam lagi @pakustadddke2"),
        ("19:00", "📈 Update TO"),
        ("19:10", "🎰 Macau"),
        ("19:45", "⏰ Reminder — 1 jam lagi @pakustadddke2"),
        ("20:45", "⏰ Reminder — 1 jam lagi @pakustadddke2"),
        ("21:00", "📋 WD Report"),
        ("21:45", "⏰ Reminder — 1 jam lagi @pakustadddke2"),
        ("22:10", "🎰 Macau"),
        ("22:35", "⏰ Reminder — 1 jam lagi @pakustadddke2"),
    ],
    "malam": [
        ("23:00", "📈 Update TO"),
        ("23:10", "🎰 Macau & HK"),
        ("23:45", "⏰ Reminder — 1 jam lagi @pakustadddke2"),
        ("00:00", "🎁 Pembagian Bonus"),
        ("00:10", "🎰 Macau"),
        ("00:20", "⚙️ Config, Pinjaman & Bersih-bersih"),
        ("00:45", "⏰ Reminder — 1 jam lagi @pakustadddke2"),
        ("01:45", "⏰ Reminder — 1 jam lagi @pakustadddke2"),
        ("02:45", "⏰ Reminder — 1 jam lagi @pakustadddke2"),
        ("03:30", "📈 Update TO Kemarin"),
        ("03:45", "⏰ Reminder — 1 jam lagi @pakustadddke2"),
        ("04:45", "⏰ Reminder — 1 jam lagi @pakustadddke2"),
        ("05:45", "⏰ Reminder — 1 jam lagi @pakustadddke2"),
        ("06:00", "📋 WD Report"),
        ("06:35", "⏰ Reminder — 1 jam lagi @pakustadddke2"),
    ]
}
